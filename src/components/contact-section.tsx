...
export default function ContactSection() {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "khandzodekrunal13@gmail.com",
  ...
  const socialLinks = [
    ...
    //   icon: Github,
    //   label: "GitHub",
    //   href: "https://github.com/khandzodekrunal",
    //   color: "hover:text-gray-400",
    // },
    {
      icon: Linkedin,
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/krunal-khandzode-1206s",
  ...
  return (
    <section id="contact" className="py-20 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={5}
                    className="bg-gray-800 border-gray-700 text-white focus:border-blue-500"
                    placeholder="Share your finance-related inquiries..."
                  />
                </div>
                {status === "success" && (
      ...
      >
        <p className="text-gray-400">© 2025 Krunal Khandzode. Crafted with passion and precision.</p>
      </motion.div>
    </section>
  )
}
